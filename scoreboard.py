...
class Scoreboard():
    ...
    def prep_score(self):
        ...
        rounded_score = int(round(self.stats.score, -1)) # 십의 자리까지 반올림함.
        score_str = "{:,}".format(rounded_score) # 포멧 양식에 정규표현식 사용, 세자리(:)마다 , 넣음.
    ...
    def prep_high_score(self):
        ...
        high_score_str =  "{:,}".format(high_score) # 포멧 양식에 정규표현식 사용, 세자리(:)마다 , 넣음.
